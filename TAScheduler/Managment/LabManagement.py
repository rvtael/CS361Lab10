...
=======
    ...
    def editLab(request, Id, labName, labHours, labLocation, labDays, labInstructor, labTA):
        ...
        return render(request, "placeholder","The lab was successfully editted")
>>>>>>> Stashed changes
...
=======
    ...
    def deleteLab(request, Id):
        ...
        return render(request, "Placeholder", retMsg)
    ...
    def displayAllLabs(request):
        ...
        return render(request, "Placeholder", data)
>>>>>>> Stashed changes
